...
- Repository skills are authored under `.apm/skills/` and deployed to Claude
  Code by APM (see [AGENTS.md](AGENTS.md)'s "Workflow skills" section).
...
`AGENTS.md` or the relevant `.apm/skills/*/SKILL.md`, not here. Update those
