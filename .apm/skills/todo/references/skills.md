...
| `fork`         | 0    | Run identity-preserving and confirmed cleanup fork workflows, including remote updates, optional history migration, cron-timing comments with certificate-renewal preservation, workflow-reference normalization, and validation without invoking bootstrap. |
